...
If you just want to try our components for demnstrations and so on, you can use CDNs that support module mapping (for example, [JSPM](https://jspm.org)). With it, you can import just our modules in `<script type="module">`:
...
- [Angular](https://web-components.carbondesignsystem.com/react/index.html)
- [React](https://web-components.carbondesignsystem.com/angular/index.html)
