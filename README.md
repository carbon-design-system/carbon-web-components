...
You can use wrapper React components in `carbon-custom-elements/es/components-react` generated [automatically from the custom elements](./src/globals/wrappers/createReactCustomElementType.ts) that allows you to use our components seamlessly from your React code. Here's an example:
