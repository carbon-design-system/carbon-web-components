...
```bash
npm install -S carbon-custom-elements carbon-components lit-html lit-element lodash.findlast @babel/runtime
```
...
```bash
yarn add carbon-custom-elements carbon-components lit-html lit-element lodash.findlast @babel/runtime
```
