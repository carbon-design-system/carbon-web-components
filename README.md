...
```bash
npm install -S carbon-custom-elements carbon-components lit-html lit-element classnames lodash.debounce lodash.throttle lodash.findlast @babel/runtime
```
...
```bash
yarn add carbon-custom-elements carbon-components lit-html lit-element classnames lodash.debounce lodash.throttle lodash.findlast @babel/runtime
```
